...
export default () => ({
	env: {
		...
		GOOGLE_OAUTH_REDIRECT_URL: process.env.GOOGLE_OAUTH_REDIRECT_URL || EnvConfigEnum.GOOGLE_OAUTH_REDIRECT_URL,
		...
		GITHUB_OAUTH_REDIRECT_URL: process.env.GITHUB_OAUTH_REDIRECT_URL || EnvConfigEnum.GITHUB_OAUTH_REDIRECT_URL,
